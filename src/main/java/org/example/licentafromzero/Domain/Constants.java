...
public final class Constants {
    ...
    //General values
    public static final int SIMULATION_TIME = 120; //seconds
    ...
    public static final int NODE_NEIGHBOUR_DISCOVERY_PERIOD = 3000;
    public static final int NODE_NEIGHBOUR_DISCOVERY_DURATION = 100;

    public static final int NODE_AODV_STALE_ROUTE_PERIOD = 1500;
